...
<body>
	...
	<header>
		...
		<div class="header_bottom">
			<div class="menubar">
				<a href="/board/noticeGetList?reqPage=1">공지사항</a> <a href="#">자유게시판</a>
				<a href="#">고민있어요</a> <a href="#">추천합니다</a> <a href="#">베스트게시글</a> <a
					href="#">가입인사</a> <a href="#">테스트할래요</a>
			</div>
			<div>
				<a class="login-btn" href="/member/loginFrm">로그인</a>
				<a class="signup-btn" href="/member/joinFrm">회원가입</a>
			</div>
		</div>
	...
	<footer>
		...
		<div class="footer_right">
			<a href="#">사이트 소개</a> <a href="#">이용약관</a> <a href="#">개인정보처리방침</a>
			<a href="#">고객센터</a>
		</div>
	</footer>
